...
draft: false
categories: []
uuid: 03607454-7f76-4258-8e8c-56365a286d57
layout: page
title: Coaching
id: 375
tags: []
...
# Start Your Autoimmune Management Journey

I help you move from being overwhelmed by symptoms to managing them with a proven, data-driven lifestyle strategy. Whether you are just starting or need advanced refinement, we will build a plan that fits your life.
...
### 5 Sessions: The Fundamentals
**Cost:** 270 EUR
We will establish your baseline, identify your primary food and stress triggers, and implement the core pillars of the Factastic Health protocol.
...
### 10 Sessions: Advanced Strategy & Accountability
**Cost:** 510 EUR
For deep transformation. We cover refined nutrition, advanced tracking, fasting protocols (if applicable), and mental resilience tools to ensure long-term remission.
1. [Purchase Package (Paypal)](https://paypal.me/factastichealth)
2. [Schedule your first session](https://calendar.app.google/iLnvkgBp3pSbihq27)
...
No. While our personal expertise comes from managing AS, the principles of reducing the atack of the immune system to our own body, reducing inflamation with gut health, stress management and movement apply to most autoimmune conditions (like Rheumatoid arthritis, Lupus, Hashimoto’s, Psoriasis, etc.). We focus on the *drivers* of inflammation, which are often similar across different diagnoses.
</details>
<details>
